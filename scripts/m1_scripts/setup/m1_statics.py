measurement.AdwinControlledMeasurement.adwin_processes_key = 'adwin_m1_processes'
...
pulsar_msmt.PulsarMeasurement.mwsrc = qt.instruments['SGS100A_1']
pulsar_msmt.PulsarMeasurement.mwsrc2 = qt.instruments['SGS100A_2']
