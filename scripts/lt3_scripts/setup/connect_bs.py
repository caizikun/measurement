if objsh.start_glibtcp_client('192.168.0.90', port=12003, nretry=1):
	...
	tel1_remote_ins_server = objsh.helper.find_object('qtlab_bs_monitor:instrument_server')
	print tel1_remote_ins_server
	tel1_helper = qt.instruments.create('tel1_helper', 'Remote_Instrument', remote_name = 'bs_measurement_helper',inssrv=tel1_remote_ins_server)
