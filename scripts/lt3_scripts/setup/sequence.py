...
qt.pulsar.define_channel(id='ch2_marker2', name='AOM_Yellow', type='marker', 
    high=0.5, low=0, offset=0., delay=0e-9, active=True)
qt.pulsar.define_channel(id='ch1_marker2', name='RND_halt', type='marker', 
    high=0.5, low=0, offset=0.5, delay=0e-9, active=True)
...
qt.pulsar.define_channel(id='ch3', name='AOM_Matisse', type='analog', high=1.0,
    low=-1.0, offset=0., delay=500e-9, active=True) 
#EOM
...
qt.pulsar.define_channel(id='ch4_marker1', name='EOM_AOM_Matisse', type='marker', 
    high=1.0, low=0.0, offset=0.0, delay=617e-9, active=True) #617 ns for normal pulses
