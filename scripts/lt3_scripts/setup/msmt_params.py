...
f_msm1_cntr = 2.807415e9# +/-   0.000018           #Electron spin ms=-1 frquency
...
cfg['protocols'][name]['pulses'] = {
        ...
        'Hermite_pi_amp': 0.908 , #BELL # 2015-04-14 for pi pulse of 180 ns
        'Hermite_pi2_length': 50e-9,
        'Hermite_pi2_amp': 0.8095,#2015-04-14 for pi/2 pulse of 50 ns
