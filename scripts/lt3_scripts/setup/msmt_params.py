...
cfg.set(branch+        'cr_wait_after_pulse_duration', 3)
...
f_msm1_cntr = 2.8367e9   
f_msp1_cntr = 2.878e9    #not calibrated
...
cfg.set(branch+'Ex_RO_amplitude', 1e-9)
...
cfg.set(branch+'SSRO_duration', 33)
