...
central_freqs = [4.062]#,4.062]#[4.14]#[1.8,1.9,2.,2.1,2.2,2.3,2.4,2.5,2.6,2.7,2.8]

for cent in central_freqs:
    start_f = cent - 0.01#1.85#2.878 - 0.08 #   2.853 #2.85 #  #in GHz
    stop_f  = cent + 0.01#1.95#2.878 + 0.08 #   2.864 #2.905 #   #in GHz
    steps   = 51
