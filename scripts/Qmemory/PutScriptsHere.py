"""
Description of this script comes here.
...
def QMem(name, carbon_list   = [5],               
    ...
    m.params['MBE_bases']           = []# should be mbe_bases as soon as mbe is implemented mbe_bases
    ...
    m.params['average_repump_time'] = pts*[500e-9]
    m.params['fast_repump_repetitions'] = np.arange(1,41,4)
...
if __name__ == '__main__':
    ...
    #     	QMem(ro+'_Tomo_'+tomo+'_C5',debug=True,tomo_list = [tomo], el_RO = ro)