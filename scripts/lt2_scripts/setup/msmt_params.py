...
'C1_freq'       :   450.301e3,  
'C1_freq_0'     :   431.9955e3, #2 Hz uncertainty   
'C1_freq_1'     :   469.027e3,           
...
'C1_Ren_tau'    :   [4.998e-6],
'C1_Ren_N'      :   [34],
'C1_Ren_extra_phase_correction_list' :  np.array([0] + [48.6] + [107.8]+[0]*2+[25.55]+ 4*[0]),#np.array([0] + [-10.7] + [101.93]+[0]*2+[25.33]+ 4*[0]),
...
'C2_Ren_N'      :   [32],
'C2_Ren_extra_phase_correction_list' : np.array([0]+[68.3]+[168.3]+[0]*2+[69.9]+[0]*4), #np.array([0]+[69.95]+[184.8]+[0]*2+[66.75]+[0]*4), 
...
'C5_Ren_N'      :   [48],
'C5_Ren_extra_phase_correction_list' : np.array([0]+[85.6]+[-7.4]+[0]*2+[109.7]+[0]*4), #np.array([0]+[83.24]+[10.6]+[0]*2+[72.7]+[0]*4), 
...
'A_RO_amplitude' : 0,
'A_SP_amplitude' : 17e-9,   #30e-9 # 40e-9,
'CR_duration'    : 100,     # 50
'CR_preselect'   : 1000,
'CR_probe'       : 1000,
'CR_repump'      : 1000,
...
'fast_pi_amp'               :  0.399529,#0.389050,#0.393042,#0.401147,#0.392860,#0.794559, #250 MHz, slow
...
'fast_pi2_amp'              :   0.420067,#0.407681,#0.410445, # slow, only calibrated with 2 pulses
...
'Ex_MBI_amplitude'          :           0.35e-9,
'MBI_duration'              :           40,

    #Repump after succesfull MBI
'repump_after_MBI_duration' :           [100],
'repump_after_MBI_A_amplitude':         [18e-9],
