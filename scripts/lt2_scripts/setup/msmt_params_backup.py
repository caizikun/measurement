...
'green_repump_amplitude'    :       20e-6,#40e-6#70#50e-6, #200e-6,
...
if electron_transition == '-1':
    ...
    Hermite_pi_amp = 0.926 #0.481 #for 150 ns

    Hermite_pi2_duration = 65e-9#56e-9 # divsible by 2
    Hermite_pi2_amp = 0.93
...
# # For ms = +1
    ...
    Hermite_pi_duration = 250e-9    
    Hermite_pi_amp = 0.92#0.759 
...
mw2_Hermite_pi_amp = 0.5#0.759 

mw2_Hermite_pi2_duration = 70e-9#56e-9, #should be divisible by 4, slow
mw2_Hermite_pi2_amp = 0.9  

mw2_Square_pi_duration = 191e-9#180e-9   #250 MHz slow
mw2_Square_pi_amp =  0.666457#0.694552  #0.407225 #without switch #0.469424,with switch  #250 MHz, slow
...
'C1_Ren_N_m1'      :   [42],
'C1_Ren_extra_phase_correction_list_m1' : np.array([0.0] + [-13.91] + [179.94] + [-15.74] + [0.0] + [22.54] + [3.15] + [0.0] + [0.0] + [0.0]),
...
'C2_Ren_N_m1'      :   [32],
'C2_Ren_extra_phase_correction_list_m1' : np.array([0.0] + [103.7] + [188.89] + [-27.18] + [0.0] + [28.59] + [-1.52] + [0.0] + [0.0] + [0.0]),
...
'C3_Ren_N_m1'      :   [14],
'C3_Ren_extra_phase_correction_list_m1' : np.array([0.0] + [39.28] + [106.34] + [24.94] + [0.0] + [13.08] + [-7.88] + [0.0] + [0.0] + [0.0]),
...
'C5_Ren_N_m1'      :   [48],
'C5_Ren_extra_phase_correction_list_m1' : np.array([0.0] + [133.25] + [-19.48] + [-13.59] + [0.0] + [99.23] + [-8.49] + [0.0] + [0.0] + [0.0]),
...
'C6_freq_0' : 432012.26,
'C6_freq_1_m1' : 480649.81,

'C6_Ren_tau_m1'    :   [4.932e-6],
'C6_Ren_N_m1'      :   [92],
'C6_Ren_extra_phase_correction_list_m1' : np.array([0.0] + [90.49] + [-99.67] + [-32.6] + [0.0] + [32.04] + [28.96] + [0.0] + [0.0] + [0.0]),
...
'A_CR_amplitude' : 12e-9, #8e-9,   #20e-9
'A_RO_amplitude' : 0.,
...
'BB1_fast_pi_duration'              :  100e-9,
'BB1_fast_pi_amp'                   :  0.786,
