...
if 0:
	...
	'''Carbon 4 phases:''' 
		...
		#between first and second Ren
	t_Ren4_1 = 376 + 5e3 + 5584 + 5e3 + 376 + 2.*pi_len/2. - 2*C4_Ren_tau
	t_Ren4_1_periods, t_Ren4_1_phase 	= get_periods_phase(4, t_Ren4_1) 

		#between second and third Ren
	t_Ren4_2 = (376 + 5e3 + 116e3 + 2e3 + 
			    8e3 + 1840 + 17*16e3 + 16*2840 + 1840 + 8e3 + 5624 + 
			    8e3 + 1840 + 17*16e3 + 16*2840 + 1840 + 8e3 + 116e3 + 6264 +
			    5e3 + 376 + 2.*pi_len/2. - 2*C4_Ren_tau)
	t_Ren4_2_0 = (376 + 5e3 + 116e3 + 958 + pi_len/2. + pi2_len/2. - C4_Ren_tau +
				  340 + 8e3 + 116e3 + 1188 + pi_len/2. + pi_len/2. - C1_Ren_tau -  534/2.)  ### The time that the electron was in 0 instead of being DDed
	t_Ren4_2_periods, t_Ren4_2_phase 	= get_periods_phase(4, t_Ren4_2, t_Ren4_2_0)

		#between third and fourth Ren
	t_Ren4_3 = (376 + 5e3 + 6312 +
			    8e3 + 1840 + 17*16e3 + 16*2840 + 1840 + 8e3 + 
			    2e3 + 116e3 + 4424 +  
			    5e3 + 376 + 2.*pi_len/2. - 2*C4_Ren_tau)
	t_Ren4_3_0 = (pi2_len/2. + 958 + 116e3 + 958 + pi2_len/2.)  ### The time that the electron was in 0 instead of being DDed
	t_Ren4_3_periods, t_Ren4_3_phase 	= get_periods_phase(4, t_Ren4_3, t_Ren4_3_0)
	...
	t_Ren1_1_periods, t_Ren1_1_phase 	= get_periods_phase(1, t_Ren1_1)
		...
		#Ren 2 -> 3
	t_Ren1_2 	= (340 + 8e3 + 116e3 + 6264 + 
				  5e3 + 1912 + 39*10e3 + 38*2912 + 1912 + 5e3 +
				  6312 + 8e3 + 340 + 2*pi_len/2 -2*C1_Ren_tau) 

	t_Ren1_2_0 	= (340 + pi_len/2. - C1_Ren_tau + 8e3 +
				  116e3 + 958 + pi2_len/2.) ### The time that the electron was in 0 instead of being DDed
	t_Ren1_2_periods, t_Ren1_2_phase 	= get_periods_phase(1, t_Ren1_2, t_Ren1_2_0)


	t_Ren1_3 = (340 + 8e3 + 2e3 + 116e3 + 4424 + 
				5e3 + 1912 + 39*10e3 + 38*2912 + 1912 + 5e3 + 
				4087 + 8e3 + 340 + 2*pi_len/2 -2*C1_Ren_tau)
	t_Ren1_3_0 = (pi2_len/2. + 958 + 116e3 + 958 + pi2_len/2.)
	t_Ren1_3_periods, t_Ren1_3_phase 	= get_periods_phase(1, t_Ren1_3, t_Ren1_3_0)
	...
	print 't_Ren1_1_phase = ' 	+ str(t_Ren1_1_phase) 
	print 't_Ren1_2_phase = ' 	+ str(t_Ren1_2_phase) 
	print 't_Ren1_2_phase = ' 	+ str(t_Ren1_3_phase) 
...
if 1:
	...
	t_Ren4_2 = (376 + 5e3 + 116e3 + 2e3 + 
			    ...
			    5e3 + 376 + 2.*pi_len/2. - 2*C4_Ren_tau)
	t_Ren4_2_0 = (376 + 5e3 + 116e3 + 958 + pi_len/2. + pi2_len/2. - C4_Ren_tau +
				  340 + 8e3 + 116e3 + 958 + pi_len/2. + pi2_len/2. - C1_Ren_tau)  ### The time that the electron was in 0 instead of being DDed
	t_Ren4_2_periods, t_Ren4_2_phase 	= get_periods_phase(4, t_Ren4_2, t_Ren4_2_0)
	...
	t_Ren1_3 = (340 + 8e3 + 2e3 + 116e3 + 5144 + 
				5e3 + 1912 + 39*10e3 + 38*2912 + 1912 + 5e3 + 
				4095 + 8e3 + 340 + 2*pi_len/2 -2*C1_Ren_tau)
	t_Ren1_3_0 = (pi2_len/2. + 958 + 116e3 + 958 + pi2_len/2.)
	t_Ren1_3_periods, t_Ren1_3_phase 	= get_periods_phase(1, t_Ren1_3, t_Ren1_3_0)
