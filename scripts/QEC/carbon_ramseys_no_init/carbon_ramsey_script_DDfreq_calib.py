...
if __name__ == '__main__':
    ...
    evolution_times1 = np.linspace(5e3,80e3,14).astype(int)*1e-9
    evolution_times2 = np.linspace(85e3,165e3,14).astype(int)*1e-9
    evolution_times3 = np.linspace(165e3,245e3,14).astype(int)*1e-9
    carbon=1
    #for carbon in [1,5]:
