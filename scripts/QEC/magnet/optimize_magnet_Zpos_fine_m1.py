...
for i in range (1):
    ...
    if __name__ == '__main__':
        ...
        ###########
          ...
          # Measure B-field 
        darkesr('magnet_optimize_Bfield_msmnt', range_MHz=fine_range, pts=fine_pts, reps=fine_reps, 
        ...
        while abs(delta_f0_temp) > optimization_target:
            ...
            move_to_position = current_position + delta_f0_temp/field_gradient*1e-6
            ...
            if u_f0_temp*1e6 < 5:
                ...
                magnet_Z_scanner.MoveAbsolute(move_to_position)
                print 'moving magnet...'
