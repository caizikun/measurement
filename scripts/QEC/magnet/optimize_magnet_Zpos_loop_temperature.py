...
for i in range (200):
    ...
    if __name__ == '__main__':
        ...
        optimization_target = 10      # Target difference frequency in kHz , first (03.08) was 10 then 7 then 10 again
        ...
        if abs(delta_temp) > 0.0035:
            ...
            while abs(delta_f0_temp) > optimization_target:
                ...
                if delta_f0_temp > 300 and only_fine == False:
                    darkesr('magnet_optimize_coarse_step_' + str(iterations), range_MHz=coarse_range, pts=coarse_pts, reps=coarse_reps, 
                        power = coarse_amplitude, MW_power = coarse_MW_power, pulse_length=coarse_pulse_length)
                    ...
                    darkesr('magnet_optimize_fine_step_' + str(iterations), range_MHz=fine_range, pts=fine_pts, reps=fine_reps, 
