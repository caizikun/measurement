...
def MBE(name, carbon_list   = [1,5,2],               
    ...
    # if RO_C == 1:
    #     m.params['Tomo_Bases_00'] = ['Y','I','I']
    #     m.params['Tomo_Bases_01'] = ['Y','I','I']
    #     m.params['Tomo_Bases_10'] = ['-Y','I','I']
    #     m.params['Tomo_Bases_11'] = ['Y','I','I']

    # elif RO_C == 2:
    #     m.params['Tomo_Bases_00'] = ['I','Y','I']
    #     m.params['Tomo_Bases_01'] = ['I','Y','I']
    #     m.params['Tomo_Bases_10'] = ['I','Y','I']
    #     m.params['Tomo_Bases_11'] = ['I','-Y','I']
    # elif RO_C == 3:
    #     m.params['Tomo_Bases_00'] = ['I','I','Y']
    #     m.params['Tomo_Bases_01'] = ['I','I','-Y']
    #     m.params['Tomo_Bases_10'] = ['I','I','Y']
    #     m.params['Tomo_Bases_11'] = ['I','I','Y']
    ####################
    ### MBE settings ###
    ####################
