...
if __name__ == '__main__':
    ...
    ### Carbon1 ##
    Number_of_pulses_list = np.concatenate([np.arange(1),np.arange(28,57,2)])
    ...
    ### Carbon5 ##
    Number_of_pulses_list = np.concatenate([np.arange(1), np.arange(32,61,2)])
    ...
    ### Carbon2 ##
    Number_of_pulses_list   = np.concatenate([np.arange(1),np.arange(16,26,2)])
