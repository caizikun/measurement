...
if __name__ == '__main__':
    ...
    # SimpleDecoupling(SAMPLE+'sweep_tau_N_128',sweep='tau',N=128,end=70e-3)
    
    # SimpleDecoupling(SAMPLE+'sweep_tau_N_256',sweep='tau',N=256,end=100e-3)
    ...
    print 'uncomment to measure'

"""""
Don't really know what this is. NK 20150429
It was apparently used to measured T1 of the electron, by setting the pi pulse amplitude to 0?
"""""
...
#         pts = 10
#         Number_of_pulses = 256 #256
#         start   = 5e-3 + tau_larmor*(2*Number_of_pulses)
#         end     = 300e-3
#         nr_list = np.linspace(start/(2*Number_of_pulses)/tau_larmor, end/(2*Number_of_pulses)/tau_larmor, pts).astype(int)
#         tau_list = nr_list*tau_larmor
