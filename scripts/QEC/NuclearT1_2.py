...
def NuclearT1_2(name, carbon            =   1,               
    ...
    m.params['free_evolution_time'] = np.r_[10e-3, 500e-3, 1., 2., 5., 10.]
    m.params['free_evolution_time'] = np.r_[10e-4, 50e-4,50e-3,100e-3, 200e-3, 500e-3, 1., 2.]
    # m.params['use_shutter'] = True
