...
def sweep_bell(name, setup = 'lt3'):
    ...
    if setup == 'lt3' :
        ...
        m.params['eom_off_amplitude']         = np.ones(pts)*-0.255 # calibration from 01-07-2014 8#np.linspace(-0.28,-0.22,pts) #
    ...
    m.params['wait_for_PLU'] = 0

    m.params['do_general_sweep']= 0# sweep the parameter defined by general_sweep_name, with the values given by general_sweep_pts
