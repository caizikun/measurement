...
if __name__ == '__main__':
    ...
    # cal_fast_pi(SAMPLE_CFG+'msm1',mult=3,min_pulse_amp =0.801227-0.04, max_pulse_amp =0.801227+0.04, mbi = True)
    # cal_fast_pi(SAMPLE_CFG+'msm1',mult=11,min_pulse_amp = 0.817271-0.04, max_pulse_amp =0.817271 +0.04, mbi = True)
    cal_fast_pi2(SAMPLE_CFG, mult=14, min_pulse_amp = 0.818524 -0.05, max_pulse_amp =0.818524+0.05, mbi = True)
