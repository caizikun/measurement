...
def run(name):
    ...
    m.params['MW_pulse_amps']       = np.ones(pts) * 0.05
    m.params['MW_pulse_mod_frqs']   = np.linspace(m.params['MW_modulation_frequency']-2.5e6, m.params['MW_modulation_frequency']+6.5e6, pts)
