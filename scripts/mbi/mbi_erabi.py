...
def run(name):
    ...
    if sweep_duration:        
    # MW pulses
        m.params['MW_pulse_amps']       = np.ones(pts) * 0.1755#m.params['pi2pi_mIm1_amp']
        m.params['MW_pulse_durations']  = np.linspace(0,800e-9,pts) # 05-30-'14 Took away the +10 ns -Machiel
