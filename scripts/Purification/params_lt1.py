...
params_lt1['MW_1_separation']           = joint_params.joint_params['opt_pulse_separation'] #or alternatively tau_larmor
...
params_lt1['phase_correct_max_reps']    = 10 # should really be joint params. move later