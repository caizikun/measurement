...
class Bell_lt3(Pubell.Bell):
    ...
    def __init__(self, name):
        ...
        for k in Puparams_lt3.params_lt3:
            self.params[k] = Puparams_lt3.params_lt3[k]

    def autoconfig(self, **kw):
        Pubell.Bell.autoconfig(self, **kw)
    ...
    def stop_measurement_process(self):
        Pubell.Bell.stop_measurement_process(self)
