...
# SweepBell.bs_helper = qt.instruments['bs_helper'] ### no more Bs station
...
def _setup_params(msmt, setup):
    ...
    m.PQ_ins=qt.instruments['TH_260N'] ### necessary for PSB measurements. Needs to be redefined for LT4 msmts
