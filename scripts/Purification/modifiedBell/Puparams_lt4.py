...
params_lt4['wait_before_RO'] = Pujoint_params.joint_params['wait_for_1st_revival']*params_lt4['free_precession_time_1st_revival']*1e6+10
...
params_lt4['MW_1_separation'] 		  = Pujoint_params.joint_params['opt_pulse_separation']
...
params_lt4['MAX_DATA_LEN'] 			=       Pujoint_params.joint_params['MAX_DATA_LEN']
params_lt4['BINSIZE'] 				=       Pujoint_params.joint_params['BINSIZE'] #2**BINSIZE*BASERESOLUTION 
params_lt4['MIN_SYNC_BIN'] 			=       Pujoint_params.joint_params['MIN_SYNC_BIN']
params_lt4['MAX_SYNC_BIN'] 			=       Pujoint_params.joint_params['MAX_SYNC_BIN']
params_lt4['MIN_HIST_SYNC_BIN'] 	=  		Pujoint_params.joint_params['MIN_HIST_SYNC_BIN']
params_lt4['MAX_HIST_SYNC_BIN'] 	=  		Pujoint_params.joint_params['MAX_HIST_SYNC_BIN']
params_lt4['TTTR_RepetitiveReadouts']=	 	Pujoint_params.joint_params['TTTR_RepetitiveReadouts']
params_lt4['TTTR_read_count'] 		=    	Pujoint_params.joint_params['TTTR_read_count']
params_lt4['measurement_abort_check_interval'] = Pujoint_params.joint_params['measurement_abort_check_interval']
params_lt4['wait_for_late_data'] 	= 		Pujoint_params.joint_params['wait_for_late_data']
