    ...
    if hasattr(qt,'master_script_is_running'):
        if qt.master_script_is_running:
            ...
            for i in range(1):
                ...
                PurifyXX(name+'_Purify25_LT3X_LT4Y_'+str(qt.purification_name_index+i),debug = False, upload_only = False)
                ...
                PurifyXX(name+'_Purify25_LT3X_LT4Z_'+str(qt.purification_name_index+i),debug = False, upload_only = False)
                ...
                PurifyYY(name+'_Purify25_LT3Y_LT4X_'+str(qt.purification_name_index+i),debug = False, upload_only = False)
                ...
                PurifyYY(name+'_Purify25_LT3Y_LT4Z_'+str(qt.purification_name_index+i),debug = False, upload_only = False)
                AWG.clear_visa()
                ## ZX measurement
                print '-----------------------------------'            
                print 'press q to stop measurement cleanly'
                ...
                PurifyZZ(name+'_Purify25_LT3Z_LT4X_'+str(qt.purification_name_index+i),debug = False, upload_only = False)
                AWG.clear_visa()
                ## ZY measurement
                print '-----------------------------------'            
                print 'press q to stop measurement cleanly'
                ...
                PurifyZZ(name+'_Purify25_LT3Z_LT4Y_'+str(qt.purification_name_index+i),debug = False, upload_only = False)
                AWG.clear_visa()
