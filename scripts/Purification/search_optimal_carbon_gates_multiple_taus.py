...
if __name__ == '__main__':
	...
	if qt.current_setup == 'lt3':
		...
		multi_tau_carbon_dict['C4'] = {'C_taus' 	: [6.52e-6, 7.7e-6, 8.88e-6], 
										'C_tau_rng'  :14e-9, # steps of 2e-9
										'C_N' 		: [28,30,30], 
										'C_N_steps' : 10} # steps of 2 	


		multi_tau_carbon_dict['C5'] = {'C_taus' 	: [5.29e-6,6.47e-6,7.62e-6,8.826e-6],#[6.4e-6, 8.73e-6]
										'C_tau_rng'  :14e-9, # steps of 2e-9
										'C_N' 		: [34,34,16,36],#[36,44], # 34,
										'C_N_steps' : 10} # steps of 2 	
		...
		multi_tau_carbon_dict['C8'] = {'C_taus' 	: [3.87e-6, 4.98e-6, 6.09e-6], # 3.83e-6, 6.04e-6,
		 								'C_tau_rng' : 14e-9,
										'C_N' 		: [36 ,36, 42],  #34, 42,
										'C_N_steps' : 10} 
