...
def calibrate_pi_pulse(name, multiplicity=1, debug=False, mw2=False, **kw):
    ...
    rng = 0.3 if multiplicity == 1 else 0.1 if multiplicity <= 5 else 0.05
...
if __name__ == '__main__':
    calibrate_pi_pulse(SAMPLE_CFG + 'Pi', multiplicity = 1, debug = False, mw2=False, pulse_shape='Hermite')
