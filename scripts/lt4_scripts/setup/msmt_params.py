...
###############
	...
	# C4 (A ~ 26) #
	###############
	'C4_freq_m1'        : (419745.71+446037.72)/2,
	'C4_freq_0' 		: 446126.51,
	'C4_freq_1_m1' 		: 419816.27,

	'C4_Ren_tau_m1'    :   [6.36e-6], #6.52e-6
	'C4_Ren_N_m1'      :   [32], #28
	'C4_Ren_extra_phase_correction_list_m1' : np.array([0.0] + [-8.99] + [63.23] + [20.11] + [136.99] + [-37.25] + [0.0] + [0.0] + [0.0] + [0.0]),
