...
params_lt3['count_int_cycles'] = int(9e5) # How many cycles to integrate counts for
...
params_lt3['phase_stab_max_cycles'] = 100000000 # How long (in units of 3.3ns) to run the expm for after phase stabilisation
