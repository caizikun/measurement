...
DIM DATA_29[max_repetitions] AS LONG
...
DIM do_calculate_phase, a_case AS LONG
DIM c_n, pi, cosine, sine, th, real, imag AS FLOAT
DIM timer1, timer2 AS LONG
DIM G, F, renorm_ssro_M AS LONG
DIM fid0, fid1 AS FLOAT
