  ...
  ELSE
    ...
    SELECTCASE mode
      ...
      CASE 3    'set phase to fpga
        ...
        DATA_34 [sweep_index] = n      
        DATA_35 [sweep_index] = 3
      ...
      CASE 7    'set Bayesian update parameters --- renormalize ssro
        ...
        cos1 = COS(c1)
        sin1  = SIN(c1)  
        'DATA_36[sweep_index] = c0*180/pi-180
        'DATA_37[sweep_index] = c1*180/pi
      ...
      CASE 10 'Bayesian update of ms=0 (1=click) for phase estimation (distributed in 4 modes)          
        p_real [1+t_n] = 0.5*p0_real[1+t_n] + 0.25*(cos1*(p0_real [1] + p0_real [1+2*t_n])) 
        mode = 11
