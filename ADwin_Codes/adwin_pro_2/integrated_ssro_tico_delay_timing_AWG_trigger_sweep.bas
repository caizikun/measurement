...
DIM AWG_trigger_sweep_counter AS LONG
...
SUB AWG_trigger_moment_sweep()
  
  SELECTCASE AWG_trigger_sweep_counter
    CCASE 19:
      NOP
    CCASE 18:
      NOP
  ...
  AWG_trigger_sweep_counter = AWG_trigger_sweep_counter + 1
  IF (AWG_trigger_sweep_counter > 19) THEN
    AWG_trigger_sweep_counter = 0
  ENDIF
ENDSUB
