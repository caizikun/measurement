    ...
    SELECTCASE mode
      ...
      CASE 10 'Phase stabilisation
        ...
        ELSE
          ...
          if (store_index>=pid_points+first_time_phase_stab*5) then
            if (is_master > 0) then
            ...
            timer = -1
            remaining_time_in_long_CR_check = 10000
      ...
      CASE 2 'CR check     
        ...
        'XXX
        IF ((cr_result = 1) and (remaining_time_in_long_CR_check > 0)) THEN
          cr_result = -1
        ENDIF
