...
' modes:
'   0 : CR check
'   1 : wait for second setup (lt3)
'   2 : E spin pumping into ms=+/-1
'   3 : MBI of one carbon spin
'   4 : communicate MBI success to other adwin
'   5 : count repetitions of the entanglement sequence while waiting for PLU success signal
'   6 : wait for AWG (SWAP gate)
'   7 : spin-readout
'   8 : communicate success to other adwin
'   9 : count repetitions of the entanglement sequence while waiting for PLU success signal
'  10 : calculate phase compensation and signal to AWGs
'  11 : wait for AWG (purification gate)
'  12 : SSRO
'  13 : wait for AWG (Tomo Gate)
'  14 : SSRO
