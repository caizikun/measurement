...
#INCLUDE .\djump_tico_helper_internal_trig.inc
...
DIM delay_trigger_DI_channel, delay_trigger_DI_pattern, delay_trigger_DO_channel, delay_strobe_DO_channel AS LONG
...
Init:
  ...
  delay_trigger_DO_channel  = DATA_20[6]
  ...
  tico_delay_line_init(DIO_MODULE, delay_trigger_DI_pattern, delay_strobe_DO_channel, delay_trigger_DO_channel)
