...
EVENT:
  ...
  IF ((PxAction = 1) OR (PxAction = 2)) THEN
    ...
    DATA_11[CurrentStep] = CNT_READ(1)                 'read latch A of counter 1
    DATA_12[CurrentStep] = CNT_READ(2)                 'read latch A of counter 2
    DATA_13[CurrentStep] = CNT_READ(3)                 'read latch A of counter 3
