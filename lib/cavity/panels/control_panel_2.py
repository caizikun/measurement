...
class ControlPanelGUI (QtGui.QMainWindow):
    ...
    def set_laser_power (self, value):
        self._exp_mngr.set_power_level(value)
    ...
    def set_p1 (self, value):
        self._moc.set_fine_piezo_voltages(v1 = value, v2 = value, v3 = value)
    ...
    def set_slide_p1 (self, value):
        ...
        self._moc.set_fine_piezo_voltages(v1 = value_V, v2 = value_V, v3 = value_V)
