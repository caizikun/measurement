...
# Form implementation generated from reading ui file 'scan_panel_v3.ui'
#
# Created: Fri Jan 29 17:34:37 2016
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        #self.graphicsView.setGeometry(QtCore.QRect(20, 0, 921, 371))
        ...
        self.button_timeseries.setGeometry(QtCore.QRect(920, 530, 141, 23))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        ...
        self.button_2D_scan.setGeometry(QtCore.QRect(920, 570, 141, 23))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        ...
        self.label_other_tools.setGeometry(QtCore.QRect(910, 500, 91, 16))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.button_slowscan.setGeometry(QtCore.QRect(920, 610, 141, 23))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        self.button_slowscan.setFont(font)
        self.button_slowscan.setObjectName(_fromUtf8("button_slowscan"))
        self.cb_montana_sync = QtGui.QCheckBox(Form)
        self.cb_montana_sync.setGeometry(QtCore.QRect(710, 500, 141, 17))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        self.cb_montana_sync.setFont(font)
        self.cb_montana_sync.setObjectName(_fromUtf8("cb_montana_sync"))
        self.sb_nr_scans_msync = QtGui.QSpinBox(Form)
        self.sb_nr_scans_msync.setGeometry(QtCore.QRect(830, 560, 51, 22))
        self.sb_nr_scans_msync.setObjectName(_fromUtf8("sb_nr_scans_msync"))
        self.label_nr_scans_msync = QtGui.QLabel(Form)
        self.label_nr_scans_msync.setGeometry(QtCore.QRect(710, 560, 111, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        self.label_nr_scans_msync.setFont(font)
        self.label_nr_scans_msync.setObjectName(_fromUtf8("label_nr_scans_msync"))
        self.label_delay_msync = QtGui.QLabel(Form)
        self.label_delay_msync.setGeometry(QtCore.QRect(710, 530, 71, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        self.label_delay_msync.setFont(font)
        self.label_delay_msync.setObjectName(_fromUtf8("label_delay_msync"))
        self.sb_delay_msync = QtGui.QSpinBox(Form)
        self.sb_delay_msync.setGeometry(QtCore.QRect(830, 530, 51, 22))
        self.sb_delay_msync.setObjectName(_fromUtf8("sb_delay_msync"))
        self.label_sweep_msyncdelay = QtGui.QLabel(Form)
        self.label_sweep_msyncdelay.setGeometry(QtCore.QRect(710, 620, 201, 16))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_mindelay_msync = QtGui.QLabel(Form)
        self.label_mindelay_msync.setGeometry(QtCore.QRect(710, 650, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_mindelay_msync.setFont(font)
        self.label_mindelay_msync.setObjectName(_fromUtf8("label_mindelay_msync"))
        self.label_maxdelay_msync = QtGui.QLabel(Form)
        self.label_maxdelay_msync.setGeometry(QtCore.QRect(710, 680, 101, 16))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        self.label_maxdelay_msync.setFont(font)
        self.label_maxdelay_msync.setObjectName(_fromUtf8("label_maxdelay_msync"))
        self.label_nr_steps_msyncdelay = QtGui.QLabel(Form)
        self.label_nr_steps_msyncdelay.setGeometry(QtCore.QRect(710, 710, 61, 16))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        ...
        self.sb_nr_steps_msyncdelay = QtGui.QSpinBox(Form)
        self.sb_nr_steps_msyncdelay.setGeometry(QtCore.QRect(820, 710, 61, 22))
        self.sb_nr_steps_msyncdelay.setObjectName(_fromUtf8("sb_nr_steps_msyncdelay"))
        self.button_start_sweepdelay = QtGui.QPushButton(Form)
        self.button_start_sweepdelay.setGeometry(QtCore.QRect(710, 750, 75, 23))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(11)
        self.button_start_sweepdelay.setFont(font)
        self.button_start_sweepdelay.setObjectName(_fromUtf8("button_start_sweepdelay"))
        self.sb_mindelay_msync = QtGui.QSpinBox(Form)
        self.sb_mindelay_msync.setGeometry(QtCore.QRect(820, 650, 61, 22))
        self.sb_mindelay_msync.setObjectName(_fromUtf8("sb_mindelay_msync"))
        self.sb_maxdelay_msync = QtGui.QSpinBox(Form)
        self.sb_maxdelay_msync.setGeometry(QtCore.QRect(820, 680, 61, 22))
        self.sb_maxdelay_msync.setObjectName(_fromUtf8("sb_maxdelay_msync"))
        self.label_nr_repetitions = QtGui.QLabel(Form)
        self.label_nr_repetitions.setGeometry(QtCore.QRect(710, 590, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_nr_repetitions.setFont(font)
        self.label_nr_repetitions.setObjectName(_fromUtf8("label_nr_repetitions"))
        self.sb_nr_repetitions = QtGui.QSpinBox(Form)
        self.sb_nr_repetitions.setGeometry(QtCore.QRect(830, 590, 51, 22))
        self.sb_nr_repetitions.setObjectName(_fromUtf8("sb_nr_repetitions"))
        self.button_stop_sweepdelay = QtGui.QPushButton(Form)
        self.button_stop_sweepdelay.setGeometry(QtCore.QRect(710, 780, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(11)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_piezoscan.setText(_translate("Form", "JPE Piezo-Scan", None))
        ...
        self.cb_montana_sync.setText(_translate("Form", "Sync to Montana", None))
        self.label_nr_scans_msync.setText(_translate("Form", "nr scans per sync", None))
        self.label_delay_msync.setText(_translate("Form", "delay (ms)", None))
        self.label_sweep_msyncdelay.setText(_translate("Form", "Sweep Montana sync delay", None))
        self.label_mindelay_msync.setText(_translate("Form", "min delay (ms)", None))
        self.label_maxdelay_msync.setText(_translate("Form", "max delay (ms)", None))
        self.label_nr_steps_msyncdelay.setText(_translate("Form", "nr steps", None))
        self.button_start_sweepdelay.setText(_translate("Form", "START", None))
        self.label_nr_repetitions.setText(_translate("Form", "nr repetitions", None))
        self.button_stop_sweepdelay.setText(_translate("Form", "STOP", None))
