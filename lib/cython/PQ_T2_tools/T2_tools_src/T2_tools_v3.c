/* Generated by Cython 0.19.2 on Thu Dec 18 17:38:45 2014 */
...
static char __pyx_k_17[] = "D:\\measuring\\measurement\\lib\\cython\\PQ_T2_tools\\T2_tools_src\\T2_tools_v3.pyx";
static char __pyx_k_20[] = "T2_live_filter_integrated";
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("T2_tools_v3"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_14), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_20, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
