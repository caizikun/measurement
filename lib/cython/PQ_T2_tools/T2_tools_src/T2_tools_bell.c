/* Generated by Cython 0.20.2 on Tue Nov 04 11:04:48 2014 */
...
static PyObject *__pyx_pw_13T2_tools_bell_1Bell_live_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_channel)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_special)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_hist)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_t_ofl)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_t_lastsync)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_last_sync_number)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_min_sync_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_sync_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 8); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_min_hist_sync_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 9); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_hist_sync_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 10); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_wraparound)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 11); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_t2_time_factor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, 12); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "Bell_live_filter") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  __Pyx_RaiseArgtupleInvalid("Bell_live_filter", 1, 13, 13, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  __pyx_r = __pyx_pf_13T2_tools_bell_Bell_live_filter(__pyx_self, __pyx_v_time, __pyx_v_channel, __pyx_v_special, __pyx_v_hist, __pyx_v_t_ofl, __pyx_v_t_lastsync, __pyx_v_last_sync_number, __pyx_v_min_sync_time, __pyx_v_max_sync_time, __pyx_v_min_hist_sync_time, __pyx_v_max_hist_sync_time, __pyx_v_wraparound, __pyx_v_t2_time_factor);
...
static PyObject *__pyx_pf_13T2_tools_bell_Bell_live_filter(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_time, PyArrayObject *__pyx_v_channel, PyArrayObject *__pyx_v_special, PyArrayObject *__pyx_v_hist, __pyx_t_5numpy_uint64_t __pyx_v_t_ofl, __pyx_t_5numpy_uint64_t __pyx_v_t_lastsync, __pyx_t_5numpy_uint32_t __pyx_v_last_sync_number, __pyx_t_5numpy_uint64_t __pyx_v_min_sync_time, __pyx_t_5numpy_uint64_t __pyx_v_max_sync_time, __pyx_t_5numpy_uint64_t __pyx_v_min_hist_sync_time, __pyx_t_5numpy_uint64_t __pyx_v_max_hist_sync_time, __pyx_t_5numpy_uint64_t __pyx_v_wraparound, __pyx_t_5numpy_uint64_t __pyx_v_t2_time_factor) {
  ...
  __pyx_t_5numpy_uint64_t __pyx_t_41;
  __pyx_t_5numpy_uint64_t __pyx_t_42;
  __pyx_t_5numpy_uint64_t __pyx_t_43;
  __pyx_t_5numpy_uint64_t __pyx_t_44;
  __pyx_t_5numpy_uint64_t __pyx_t_45;
  __pyx_t_5numpy_uint64_t __pyx_t_46;
  __pyx_t_5numpy_uint64_t __pyx_t_47;
  __pyx_t_5numpy_uint64_t __pyx_t_48;
  __pyx_t_5numpy_uint64_t __pyx_t_49;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_npy_uint64(__pyx_v_length); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_s_u8) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_npy_uint64(__pyx_v_length); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_n_s_u8) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_4, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_npy_uint64(__pyx_v_length); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_n_s_u1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_2, __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_npy_uint64(__pyx_v_length); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_n_s_u1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_npy_uint64(__pyx_v_length); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_s_u4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    ...
    __pyx_t_4 = __Pyx_PyInt_From_npy_uint64(((__pyx_t_13 / __pyx_v_t2_time_factor) - __pyx_v_t_lastsync)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_XDECREF_SET(__pyx_v__sync_time, __pyx_t_4);
    __pyx_t_4 = 0;

    /* "T2_tools_bell.pyx":75
 *     for k in range(length):
 *         _sync_time = (t_ofl + time[k]) / t2_time_factor  - t_lastsync
 *         if channel[k] == 63:             # <<<<<<<<<<<<<<
 *             t_ofl += wraparound
 ...
 */
    ...
    __pyx_t_14 = (((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_channel.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_channel.diminfo[0].strides)) == 63) != 0);
    if (__pyx_t_14) {
 ...
 */
    ...
    __pyx_t_14 = (((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_special.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_special.diminfo[0].strides)) == 1) != 0);
    if (__pyx_t_14) {
      __pyx_t_16 = __pyx_v_k;
      __pyx_t_17 = (((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_channel.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_channel.diminfo[0].strides)) == 0) != 0);
 ...
 */
      ...
      __pyx_t_20 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_time.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_time.diminfo[0].strides)) + __pyx_v_t_ofl);
      if (unlikely(__pyx_v_t2_time_factor == 0)) {
        #ifdef WITH_THREAD
        PyGILState_STATE __pyx_gilstate_save = PyGILState_Ensure();
        #endif
      ...
      __pyx_v_t_lastsync = (__pyx_t_20 / __pyx_v_t2_time_factor);
 ...
 *             continue             # <<<<<<<<<<<<<<
 * 
 *         elif special[k] == 1 and channel[k] == 4:  # write all markers and photons in ROI
 */
      goto __pyx_L3_continue;
    }

    /* "T2_tools_bell.pyx":84
 *             continue
 * 
 *         elif special[k] == 1 and channel[k] == 4:  # write all markers and photons in ROI             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_18 = (((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_special.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_special.diminfo[0].strides)) == 1) != 0);
    if (__pyx_t_18) {
      __pyx_t_21 = __pyx_v_k;
      __pyx_t_14 = (((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_channel.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_channel.diminfo[0].strides)) == 4) != 0);
 ...
 */
      ...
      __pyx_t_23 = (__pyx_v_t_ofl + (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_time.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_time.diminfo[0].strides)));
      if (unlikely(__pyx_v_t2_time_factor == 0)) {
        #ifdef WITH_THREAD
        PyGILState_STATE __pyx_gilstate_save = PyGILState_Ensure();
        #endif
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint64_t *, __pyx_pybuffernd_hhtime.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_hhtime.diminfo[0].strides) = (__pyx_t_23 / __pyx_v_t2_time_factor);
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_hhchannel.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_hhchannel.diminfo[0].strides) = (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_channel.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_channel.diminfo[0].strides));

      /* "T2_tools_bell.pyx":87
 *             hhtime[l] = (t_ofl + time[k]) / t2_time_factor
 *             hhchannel[l] = channel[k]
 *             hhspecial[l] = special[k]             # <<<<<<<<<<<<<<
 *             sync_time[l] = _sync_time
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_hhspecial.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_hhspecial.diminfo[0].strides) = (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_special.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_special.diminfo[0].strides));
 ...
 *             l += 1
 */
      __pyx_t_28 = __Pyx_PyInt_As_npy_uint64(__pyx_v__sync_time); if (unlikely((__pyx_t_28 == (npy_uint64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_29 = __pyx_v_l;
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint64_t *, __pyx_pybuffernd_sync_time.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_sync_time.diminfo[0].strides) = __pyx_t_28;
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_sync_number.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_sync_number.diminfo[0].strides) = __pyx_v_last_sync_number;
 ...
 */
    ...
    __pyx_t_17 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_special.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_special.diminfo[0].strides)) == 0);
    if (__pyx_t_17) {
      __pyx_t_4 = __Pyx_PyInt_From_npy_uint64(__pyx_v_min_hist_sync_time); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = PyObject_RichCompare(__pyx_v__sync_time, __pyx_t_4, Py_GT); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_18 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_18 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (__pyx_t_18) {
        __pyx_t_3 = __Pyx_PyInt_From_npy_uint64(__pyx_v_max_hist_sync_time); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_4 = PyObject_RichCompare(__pyx_v__sync_time, __pyx_t_3, Py_LT); __Pyx_XGOTREF(__pyx_t_4); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_14 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_14 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
      ...
      __pyx_t_33 = (__pyx_v_t_ofl + (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_time.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_time.diminfo[0].strides)));
      if (unlikely(__pyx_v_t2_time_factor == 0)) {
        #ifdef WITH_THREAD
        PyGILState_STATE __pyx_gilstate_save = PyGILState_Ensure();
        #endif
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint64_t *, __pyx_pybuffernd_hhtime.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_hhtime.diminfo[0].strides) = (__pyx_t_33 / __pyx_v_t2_time_factor);

      /* "T2_tools_bell.pyx":96
 *         elif special[k] == 0 and _sync_time > min_hist_sync_time and _sync_time < max_hist_sync_time:
 *             hhtime[l] = (t_ofl + time[k]) / t2_time_factor
 *             hhchannel[l] = channel[k]             # <<<<<<<<<<<<<<
 *             hhspecial[l] = special[k]
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_hhchannel.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_hhchannel.diminfo[0].strides) = (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_channel.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_channel.diminfo[0].strides));
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_hhspecial.rcbuffer->pybuffer.buf, __pyx_t_37, __pyx_pybuffernd_hhspecial.diminfo[0].strides) = (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_special.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_special.diminfo[0].strides));

      /* "T2_tools_bell.pyx":98
 *             hhchannel[l] = channel[k]
 *             hhspecial[l] = special[k]
 *             sync_time[l] = _sync_time             # <<<<<<<<<<<<<<
 *             sync_number[l] = last_sync_number
 *             l += 1
 */
      __pyx_t_38 = __Pyx_PyInt_As_npy_uint64(__pyx_v__sync_time); if (unlikely((__pyx_t_38 == (npy_uint64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_39 = __pyx_v_l;
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint64_t *, __pyx_pybuffernd_sync_time.rcbuffer->pybuffer.buf, __pyx_t_39, __pyx_pybuffernd_sync_time.diminfo[0].strides) = __pyx_t_38;

      /* "T2_tools_bell.pyx":99
 *             hhspecial[l] = special[k]
 *             sync_time[l] = _sync_time
 *             sync_number[l] = last_sync_number             # <<<<<<<<<<<<<<
 *             l += 1
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_sync_number.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_sync_number.diminfo[0].strides) = __pyx_v_last_sync_number;
 ...
 */
      ...
      __pyx_t_4 = __Pyx_PyInt_From_npy_uint32((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_channel.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_channel.diminfo[0].strides))); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
 ...
 */
    ...
    __pyx_t_18 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_special.rcbuffer->pybuffer.buf, __pyx_t_41, __pyx_pybuffernd_special.diminfo[0].strides)) == 1);
    if (!__pyx_t_18) {
      __pyx_t_1 = __Pyx_PyInt_From_npy_uint64(__pyx_v_min_sync_time); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_3 = PyObject_RichCompare(__pyx_v__sync_time, __pyx_t_1, Py_GT); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_17 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_17 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (__pyx_t_17) {
        __pyx_t_3 = __Pyx_PyInt_From_npy_uint64(__pyx_v_max_sync_time); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_1 = PyObject_RichCompare(__pyx_v__sync_time, __pyx_t_3, Py_LT); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_31 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_31 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
      ...
      __pyx_t_43 = (__pyx_v_t_ofl + (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_time.rcbuffer->pybuffer.buf, __pyx_t_42, __pyx_pybuffernd_time.diminfo[0].strides)));
      if (unlikely(__pyx_v_t2_time_factor == 0)) {
        #ifdef WITH_THREAD
        PyGILState_STATE __pyx_gilstate_save = PyGILState_Ensure();
        #endif
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint64_t *, __pyx_pybuffernd_hhtime.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_hhtime.diminfo[0].strides) = (__pyx_t_43 / __pyx_v_t2_time_factor);
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_hhchannel.rcbuffer->pybuffer.buf, __pyx_t_45, __pyx_pybuffernd_hhchannel.diminfo[0].strides) = (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_channel.rcbuffer->pybuffer.buf, __pyx_t_43, __pyx_pybuffernd_channel.diminfo[0].strides));
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_hhspecial.rcbuffer->pybuffer.buf, __pyx_t_47, __pyx_pybuffernd_hhspecial.diminfo[0].strides) = (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_special.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_special.diminfo[0].strides));
 ...
 *             l += 1
 */
      __pyx_t_48 = __Pyx_PyInt_As_npy_uint64(__pyx_v__sync_time); if (unlikely((__pyx_t_48 == (npy_uint64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_49 = __pyx_v_l;
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint64_t *, __pyx_pybuffernd_sync_time.rcbuffer->pybuffer.buf, __pyx_t_49, __pyx_pybuffernd_sync_time.diminfo[0].strides) = __pyx_t_48;
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_uint32_t *, __pyx_pybuffernd_sync_number.rcbuffer->pybuffer.buf, __pyx_t_48, __pyx_pybuffernd_sync_number.diminfo[0].strides) = __pyx_v_last_sync_number;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_hhtime), 0, __pyx_v_l, NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_hhchannel), 0, __pyx_v_l, NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_hhspecial), 0, __pyx_v_l, NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_sync_time), 0, __pyx_v_l, NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_50 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_sync_number), 0, __pyx_v_l, NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_50)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_50);
  __pyx_t_51 = __Pyx_PyInt_From_npy_uint64(__pyx_v_l); if (unlikely(!__pyx_t_51)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_51);
  __pyx_t_52 = __Pyx_PyInt_From_npy_uint64(__pyx_v_t_ofl); if (unlikely(!__pyx_t_52)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_52);
  __pyx_t_53 = __Pyx_PyInt_From_npy_uint64(__pyx_v_t_lastsync); if (unlikely(!__pyx_t_53)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_53);
  __pyx_t_54 = __Pyx_PyInt_From_npy_uint32(__pyx_v_last_sync_number); if (unlikely(!__pyx_t_54)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_54);
  __pyx_t_55 = __Pyx_PyInt_From_npy_uint64(__pyx_v_EntanglementMarkers); if (unlikely(!__pyx_t_55)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_55);
  __pyx_t_56 = PyTuple_New(11); if (unlikely(!__pyx_t_56)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_56);
  PyTuple_SET_ITEM(__pyx_t_56, 0, __pyx_t_1);
  __Pyx_GIVEREF(__pyx_t_1);
  PyTuple_SET_ITEM(__pyx_t_56, 1, __pyx_t_3);
  __Pyx_GIVEREF(__pyx_t_3);
  PyTuple_SET_ITEM(__pyx_t_56, 2, __pyx_t_4);
  __Pyx_GIVEREF(__pyx_t_4);
  PyTuple_SET_ITEM(__pyx_t_56, 3, __pyx_t_2);
  __Pyx_GIVEREF(__pyx_t_2);
  __Pyx_INCREF(((PyObject *)__pyx_v_hist));
  PyTuple_SET_ITEM(__pyx_t_56, 4, ((PyObject *)__pyx_v_hist));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_hist));
  PyTuple_SET_ITEM(__pyx_t_56, 5, __pyx_t_50);
  __Pyx_GIVEREF(__pyx_t_50);
  PyTuple_SET_ITEM(__pyx_t_56, 6, __pyx_t_51);
  __Pyx_GIVEREF(__pyx_t_51);
  PyTuple_SET_ITEM(__pyx_t_56, 7, __pyx_t_52);
  __Pyx_GIVEREF(__pyx_t_52);
  PyTuple_SET_ITEM(__pyx_t_56, 8, __pyx_t_53);
  __Pyx_GIVEREF(__pyx_t_53);
  PyTuple_SET_ITEM(__pyx_t_56, 9, __pyx_t_54);
  __Pyx_GIVEREF(__pyx_t_54);
  PyTuple_SET_ITEM(__pyx_t_56, 10, __pyx_t_55);
 ...
 *     cnp.ndarray[cnp.uint32_t, ndim=1, mode='c'] channel not None,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13T2_tools_bell_1Bell_live_filter, NULL, __pyx_n_s_T2_tools_bell); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Bell_live_filter, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
