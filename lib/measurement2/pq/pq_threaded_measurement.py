"""
Measurement class for threaded measurements with Picoquant TTTR measurements as main loop
Not finished yet. So don't use this class until further notice.       AR 2014
