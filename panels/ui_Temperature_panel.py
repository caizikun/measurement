...
class Ui_Panel(object):
    def setupUi(self, Panel):
        ...
        self.stopButton.setGeometry(QtCore.QRect(40, 380, 151, 23))
        self.stopButton.setObjectName(_fromUtf8("stopButton"))
        self.setTempButton = QtGui.QPushButton(Panel)
        self.setTempButton.setGeometry(QtCore.QRect(90, 20, 111, 23))
        ...
        self.setTemp.setGeometry(QtCore.QRect(20, 20, 62, 22))
