...
from ui_Temperature_plot_panel import Ui_Panel as Ui_Init 

from panel import Panel


class TempCtrlPanel2 (Panel):
    def __init__(self, parent, *arg, **kw):
        ...
        self.ui.scanButton.clicked.connect(self.start_running)
    ...
    def _instrument_changed(self,changes):
        ...
        if changes.has_key('temperature_channel_plot_DFG_values'):
            ...
            # self.ui.plot1.add_point(3,2)
            # print "in panel now", changes['temperature_channel_plot_DFG_values']
