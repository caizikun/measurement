    ...
    def _update(self):
        ...
        if (lev2_flt < self.get_he2_lvl_min()) or (volt != 'n/a' and volt < self.get_temp_voltage_min()) or (-0.1 < lev1_flt < self.get_he1_lvl_min()):
            ...
            message = 'Warning from Cryo LT2: Measured levels: \n'+\
                      ...
                      'Please help me!!!\n xxx LT2'
            recipients  = ['B.J.Hensen@tudelft.nl', 'h.bernien@tudelft.nl', 'M.S.Blok@tudelft.nl', 'julia.cramer@gmail.com','c.bonato@tudelft.nl','t.h.taminiau@tudelft.nl','adriaan.rol@gmail.com']
        ...
        if self._monitor_lt1:
            ...
            if temp_A>self.get_lt1_temp_A_max():
                ...
                message = 'Warning from Cryo LT1: \n'+\
                          ...
                          'Please help me!!!\n xxx LT1'
                recipients  = ['B.J.Hensen@tudelft.nl', 'h.bernien@tudelft.nl', 't.h.taminiau@tudelft.nl', 'M.S.Blok@tudelft.nl', 'julia.cramer@gmail.com']
