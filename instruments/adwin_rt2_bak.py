...
class adwin_rt2(adwin):
    ...
    def speed2px(self, dac_names, target_voltages, speed=500000, pxtime=5,
            minsteps=10):
        """
        Parameters:
        - dac_names : [ string ]
    ...
    # end linescan
    def get_voltages(self, dac_names=['stage_x', 'stage_y', 'stage_z']):
        return self.get_dac_voltages(dac_names)

    def move_to_voltages(self, dac_names, target_voltages,
            speed=500000, blocking=False):
        current_voltages = self.get_voltages(dac_names)
