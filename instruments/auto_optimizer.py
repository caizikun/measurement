...
class auto_optimizer(Instrument):
    ...
    def __init__(self, name, get_freq_yellow = None, set_freq_yellow = None, get_counts_yellow = None, get_attemps_yellow = None,
        ...
        ins_pars  ={'do_plot'               :   {'type':types.BooleanType,'val':True,'flags':Instrument.FLAG_GETSET},
                    ...
                    'check_yellow_threshold':   {'type':types.FloatType,  'val':15,'flags':Instrument.FLAG_GETSET},                    
    ...
    def flow(self, state = 0):
        ...
        5. Do you have low counts on yellow? YES: go to 6. NO: go to 8. // Do you have high counts on yellow? YES: go to 6. NO: go to 3.
        6. Do you have both zeros and high counts on yellow? YES: go to 7. NO: go to 3 // Do you have zeros and high counts on yellow? YES: go to 7. NO: go to 8.
        7. NewFocus is off resonance. Optimize NewFocus, then go to 5.
        8. Finished succesfully.
