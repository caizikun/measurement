# This version uses the ADwin as supposed to the labjack for the Yellow laser. JM (2017)
...
class pid_controller_v4_2(Instrument):

    def __init__(self, name, set_ctrl_func=None, get_val_func=None, get_ctrl_func=None, 
        ...
        ins_pars  = {'is_running'               :   {'type':types.BooleanType,'val':False,'flags':Instrument.FLAG_GETSET},
                    ...
                    'P'                         :   {'type':types.FloatType,  'val':0.15,   'flags':Instrument.FLAG_GETSET},
