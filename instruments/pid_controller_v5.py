...
class pid_controller_v5(Instrument):

    def __init__(self, name, set_ctrl_func=None, get_val_func=None, get_val_func_fine=None,
    ...
    def _try_set_control_parameter(self,new_control_parameter):
        ...
        if (abs(new_control_parameter-self._control_parameter) > \
                ...
                new_control_parameter = self._control_parameter + \
                        np.copysign(self._max_control_deviation,new_control_parameter-self._control_parameter)
        ...
        if not(self.set_control_parameter(new_control_parameter)):
            if self.set_control_parameter_coarse(self.get_control_parameter_coarse()+ \
                    np.copysign(self._control_coarse_step,new_control_parameter-self._control_parameter)):
